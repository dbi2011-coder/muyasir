// ============================================
// 📁 الملف: assets/js/committee.js (النسخة السحابية الكاملة)
// ============================================

// =========================================================
// 🔥 دوال النوافذ المنبثقة والإشعارات (لحل خطأ showConfirmModal) 🔥
// =========================================================
...
// 4. دالة الحذف (التي كانت تسبب الخطأ)
...
function viewMemberCredentials(username, password) {
    ...
    if (uEl && pEl && modal) {
        ...
        // حل بديل إذا لم يكن تصميم النافذة موجوداً في HTML
