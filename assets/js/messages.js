...
// الوصف: شات المعلم (الكمبيوتر كما هو + حل مشاكل اختفاء الإدخال وتمدد الرأس في الجوال)
// ============================================
...
function injectChatStyles() {
    ...
    style.innerHTML = `
        ...
        /* إخفاء أزرار تنقل الجوال في الكمبيوتر */
        ...
        @media (max-width: 768px) { 
            ...
            /* 🎯 1. ضبط الحاوية الأم لمنع التمدد للخارج والمحافظة على الطول 🎯 */
            .messages-container { height: calc(100vh - 120px) !important; margin: 0 !important; padding: 0 !important; display: flex !important; flex-direction: column !important; overflow: hidden !important; }
            .chat-container { height: 100% !important; width: 100% !important; max-width: 100vw !important; border-radius: 0 !important; border: none !important; box-shadow: none !important; margin: 0 !important; overflow: hidden !important; display: flex !important; flex-direction: column !important; }
            
            /* إجبار المحادثة لتكون عمودية فقط */
            .chat-main { display: flex !important; flex-direction: column !important; height: 100% !important; width: 100% !important; max-width: 100% !important; overflow: hidden !important; }

            /* 🎯 2. الرأس: ثابت لا يتقلص ولا يتمدد لليمين 🎯 */
            .chat-header { flex-shrink: 0 !important; display: flex !important; flex-wrap: nowrap !important; align-items: center !important; justify-content: space-between !important; padding: 5px 10px !important; height: 60px !important; width: 100% !important; max-width: 100% !important; box-sizing: border-box !important; background: #fff !important; border-bottom: 1px solid #e5e7eb !important; overflow: hidden !important; }
            .header-info { display: flex !important; align-items: center !important; flex: 1 1 auto !important; min-width: 0 !important; overflow: hidden !important; }
            ...
            /* قص الاسم الطويل وتجنب دفع الأزرار خارج الشاشة */
            #chatHeaderName { white-space: nowrap !important; overflow: hidden !important; text-overflow: ellipsis !important; display: block !important; font-size: 0.95rem !important; max-width: 100% !important; color: #1f2937 !important; }
            ...
            /* إخفاء زر الـ PDF في الجوال فقط */
            .btn-pdf-chat { display: none !important; }

            /* 🎯 3. منطقة الرسائل: هي الوحيدة المسموح لها بالتمدد والتمرير (السكرول) 🎯 */
            ...
            .msg-bubble { max-width: 85% !important; word-wrap: break-word !important; overflow-wrap: break-word !important; }

            /* 🎯 4. منطقة الإدخال: ثابتة في الأسفل لا تختفي ولا تنزل 🎯 */
            .chat-input-area { flex-shrink: 0 !important; display: flex !important; flex-direction: column !important; align-items: stretch !important; padding: 8px !important; gap: 5px !important; background: #f0f2f5 !important; width: 100% !important; box-sizing: border-box !important; }
            ...
            .chat-input { flex: 1 1 auto !important; padding: 10px 15px !important; margin: 0 !important; border-radius: 20px !important; min-width: 0 !important; }
