...
// الوصف: شات المعلم (الكمبيوتر آمن 100% + تثبيت الجزء السفلي والأزرار في الجوال)
// ============================================
...
function injectChatStyles() {
    ...
    style.innerHTML = `
        ...
        @media (max-width: 768px) { 
            ...
            /* 1. هيكل المحادثة: إجبارها على أخذ مساحة الشاشة فقط */
            .messages-container { height: calc(100vh - 100px) !important; margin-bottom: 0 !important; display: flex !important; flex-direction: column !important; padding-bottom: 0 !important; }
            ...
            /* 🎯 3. منطقة الرسائل: هي الوحيدة المسموح لها بالتمدد والتمرير */
            .messages-area { flex: 1 1 auto !important; overflow-y: auto !important; min-height: 0 !important; padding: 15px !important; }

            /* 🎯 4. منطقة الإدخال (ثابتة في الأسفل ولا تتقلص ولا تختفي) */
            .chat-input-area {
                flex-shrink: 0 !important; /* هذا يمنع اختفاء الأزرار أو نزولها تحت الشاشة */
            ...
            /* خدعة CSS لكسر السطر لكي تنزل الأزرار للأسفل */
