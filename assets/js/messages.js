...
function injectChatStyles() {
    ...
    style.innerHTML = `
        ...
        @media (max-width: 768px) { 
            ...
            /* 1. رفع الجزء السفلي باستخدام dvh لضمان مساحة الهيدر وتجنب التمرير الزائد */
            ...
            #chatHeaderName { white-space: nowrap !important; overflow: hidden !important; text-overflow: ellipsis !important;
