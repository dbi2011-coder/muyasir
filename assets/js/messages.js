...
// الوصف: شات المعلم (نسخة الكمبيوتر الأصلية الآمنة تماماً + تحسينات الجوال المعزولة فقط)
// ============================================
...
function injectChatStyles() {
    ...
    style.innerHTML = `
        /* =========================================
           💻 تنسيقات الكمبيوتر (تم استعادتها من نسختك الأصلية ولم تُلمس)
        ========================================= */
        ...
        /* =========================================
           ...
           هذه الأكواد معزولة تماماً ولا تطبق أبداً على الكمبيوتر
        ========================================= */
        @media (max-width: 768px) { 
            /* امتداد المحادثة لأسفل الصفحة بالكامل */
            .messages-container { height: calc(100vh - 120px) !important; margin-bottom: -20px !important; }
            ...
            .chat-header { flex-direction: row !important; align-items: center !important; height: 60px !important; padding: 5px 10px !important; }
            .header-info { width: auto; flex: 1; overflow: hidden; display: flex; align-items: center; }
            .header-info > div { min-width: 0; }
            #chatHeaderName { white-space: nowrap; overflow: hidden; text-overflow: ellipsis; display: block; max-width: 140px; }
            
            /* أزرار الرأس في الجوال */
            .header-actions { width: auto; justify-content: flex-end; padding: 0; border: none; display: flex !important; flex-direction: row !important; gap: 5px !important; flex-shrink: 0; }
            .btn-delete-chat { background: transparent !important; color: #dc2626 !important; box-shadow: none !important; width: 35px !important; height: 35px !important; font-size: 1.4rem !important; }
            
            /* 🔴 إخفاء زر PDF في الجوال فقط */
            .btn-pdf-chat { display: none !important; }

            /* 2. منطقة الإدخال ممتدة */
            ...
            .input-tools-wrapper { order: 2 !important; width: 100% !important; justify-content: center !important; padding: 5px 0 0 0 !important; gap: 15px !important; }
            
            .chat-input { padding: 10px 15px !important; margin: 0 !important; }
            .btn-send-pill { padding: 8px 15px !important; }
            
            /* المرفقات مربعات بيضاء في المنتصف */
            .input-tools-wrapper .btn-tool { border-radius: 8px !important; width: 35px !important; height: 35px !important; font-size: 1.1rem !important; box-shadow: none !important; background: #fff !important; color: #555 !important; border: 1px solid #ddd !important; }
        }
    `;
...
function renderChatLayout() {
    ...
    // تم استخدام الهيكل الأصلي تماماً (الكمبيوتر) الذي تفضلت بإرفاقه بدون نقصان
    container.innerHTML = `
