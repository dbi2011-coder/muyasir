...
// الوصف: نظام التقارير الشامل (إصلاح مشكلة اختفاء الصفحة + تذييل ثابت للطباعة)
// ============================================
...
(function injectPrintStyles() {
    ...
    style.innerHTML = `
        /* تنسيق التذييل العام (يظهر على الشاشة) */
        .custom-footer {
            width: 100%;
            text-align: center;
            font-size: 11pt;
        ...
        @media print {
            @page {
                size: A4;
                margin: 10mm;
                margin-bottom: 25mm; /* ترك مساحة كافية للتذييل في أسفل الورقة لمنع قصه */
            }
            ...
            /* إخفاء القوائم الجانبية والعلوية لتوفير المساحة */
            .main-sidebar, .header, .sidebar, .no-print, button, input, select, .alert {
                display: none !important;
            }
            
            /* إظهار منطقة التقرير وما بداخلها فقط */
            #reportPreviewArea, #reportPreviewArea * {
                visibility: visible;
            }
            
            /* سحب منطقة التقرير للأعلى لتغطية الصفحة بالكامل */
            #reportPreviewArea {
                position: absolute;
                left: 0;
                top: 0;
            ...
            /* 🔥 إجبار التذييل على الظهور في أسفل كل صفحة مطبوعة */
            .custom-footer {
...
function generateIEPReport(studentIds, container) {
    ...
    studentIds.forEach((studentId, index) => {
        ...
        fullReportHTML += `
        <div class="student-iep-page" style="position:relative; min-height:95vh;">
...
function generateDiagnosticReport(studentIds, container) {
    ...
    studentIds.forEach((studentId, index) => {
        ...
        fullReportHTML += `
        <div class="student-diagnostic-page" style="position:relative; min-height:95vh;">
