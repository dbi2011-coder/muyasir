...
// الوصف: إدارة الدروس (احترام ترتيب المعلم)
// ============================================
...
function loadStudentLessons() {
    ...
    // 🔴 الترتيب: الاعتماد على orderIndex (ترتيب المعلم) إن وجد
    myLessons.sort((a, b) => {
        if (a.orderIndex !== undefined && b.orderIndex !== undefined) {
            return a.orderIndex - b.orderIndex;
        }
        // Fallback: الترتيب بالتاريخ
...
// ... باقي الدوال (openLessonOverlay, renderIntro, etc.) تبقى كما هي في آخر نسخة أرسلتها لك ...
// (لكن تأكد أن دالة submitAssessment تقوم بحفظ الإجابات كما في الكود السابق)
...
function closeLessonMode() { document.getElementById('lessonFocusMode').style.display = 'none'; }
...
function injectLessonModalHTML() {
    ...
    <div id="lessonFocusMode" class="lesson-focus-mode">
        <div class="focus-header"><h3>عنوان الدرس</h3><button onclick="closeLessonMode()" class="btn btn-sm btn-danger">خروج</button><div class="lesson-progress-bar"><span class="progress-step">1</span><span class="progress-step">2</span><span class="progress-step">3</span></div></div>
        <div class="lesson-container">
            ...
            <div id="stage-assessment" class="lesson-stage"><div class="alert alert-info">التقييم النهائي</div><div id="assessmentList"></div><button class="btn btn-primary btn-block mt-3" onclick="submitAssessment()">إنهاء وحفظ</button></div>
        </div>
    </div>`;
